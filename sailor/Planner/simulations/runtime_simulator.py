...
class Simulator():
    def __init__(self, sailor_path: str, training_config: dict, llm_info: dict, fp16: bool, profiles: dict, zone: Zone) -> None:
        ...
        self.inter_network_coeffs = InterNodeNetworkInfo(
            f'{sailor_path}/providers/multizone_bandwidths_het.json')

        with open(f'{sailor_path}/providers/intra_node_bandwidths.json', 'r') as f:
        ...
        with open(f'{sailor_path}/providers/gcp/communication_cost.json', 'r') as f:
